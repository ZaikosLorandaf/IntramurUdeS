...
ALTER TABLE intramurudes.league ADD CONSTRAINT league_name_sport_id_unique UNIQUE  (name, id_sport);

ALTER TABLE intramurudes.team ADD CONSTRAINT team_name_league_id UNIQUE (name, id_league);

ALTER TABLE intramurudes.player ADD CONSTRAINT player_number_team_id_unique UNIQUE  (number, id_team);

ALTER TABLE intramurudes.season ADD CONSTRAINT season_year_time_precision_unique UNIQUE  (season_year, time_precision);
...
CREATE TRIGGER trg_create_stat
    ...
    FOR EACH ROW
EXECUTE function intramurudes.create_stat();
